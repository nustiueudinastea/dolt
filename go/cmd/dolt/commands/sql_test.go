...
func NewArgFreeCliContextForTest(ctx context.Context, t *testing.T, dEnv *env.DoltEnv) cli.CliContext {
...
func DEnvWithSeedDataForTest(ctx context.Context, t *testing.T) *env.DoltEnv {
