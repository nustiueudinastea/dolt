...
import (
	...
	"github.com/nustiueudinastea/dolt/go/libraries/doltcore/mvdata"
	"github.com/nustiueudinastea/dolt/go/libraries/doltcore/rowconv"
...
func moveRows(
	...
	rdSqlSch, err := sqlutil.FromDoltSchema(ctx, "", options.destTableName, rd.GetSchema())
	if err != nil {
		return err
	}
